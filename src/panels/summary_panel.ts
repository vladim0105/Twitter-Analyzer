...
export class SummaryPanel extends Panel {
  ...
  private init() {
    ...
    let me = this.data[0].user;
    console.log("Making panel for "+me.screen_name+" aka "+me.name);
    console.log(" -- Has made "+me.statuses_count+" tweets since "+me.created_at);
    console.log(" -- Got "+me.followers_count+" followers and "+me.friends_count+" friends");
